...
orig_df = pd.read_csv('../data/movies_metadata.csv', low_memory=False) # Original file
df['overview'], df['id'] = orig_df['overview'], orig_df['id'] # Add the useful features into the cleaned dataframe
